    ...
    return (
        <>
            ...
            </button>
            {
                isOpen && (
                    <div
                        className="fixed inset-0 backdrop-blur-lg z-[80] px-2 overflow-x-hidden"
                        onClick={toggleSidebar}
                    >
                        <div className="absolute top-0 right-0 w-full max-w-64 bg-black border-l border-gray-600 p-4 overflow-y-auto h-screen hidde-scrollbar flex flex-col items-end gap-8 overflow-x-hidden z-[100]">
                            <button
